<a href="{{ route('service.show', $service['slug']) }}" wire:navigate.hover>
<div class="rounded-xl service-card-gradient p-4 sm:p-6 shadow-md border-[2px] border-color transition duration-300 ease-in-out hover:border-white hover:shadow-[0_0_10px_rgba(255,255,255,0.6)] hover:cursor-pointer">
